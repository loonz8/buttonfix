...
![Vanilla buttons remain focused after clicking while Button Fix resets the focus properly.](assets/buttons_slim.gif "Button Behavior: Vanilla vs. Button Fix")

![Vanilla sliders remain focused after dragging while Button Fix resets the focus properly.](assets/sliders_slim.gif "Slider Behavior: Vanilla vs. Button Fix")
